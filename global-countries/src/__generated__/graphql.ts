...
export type CountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', emoji: string, name: string, capital?: string | null, languages: Array<{ __typename?: 'Language', name: string }> }> };
